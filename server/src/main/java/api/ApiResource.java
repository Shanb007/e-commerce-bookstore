...
import business.book.BookDetails;
import business.book.BookSearchRequest;
...
public class ApiResource {
    ...
    public List<BookDetails> bookDetails() {
        return bookDao.findAll()
                .stream()
                .map(b -> new BookDetails(b.title(), b.author()))
    ...
    public List<Book> searchBooks(BookSearchRequest req) {
        return bookDao.searchBooks(req);
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public OrderDetails placeOrder(OrderForm form) {
        try {
            long orderId = orderService.placeOrder(form.getCustomerForm(), form.getCart());
