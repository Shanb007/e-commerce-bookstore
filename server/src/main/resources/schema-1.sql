...
--
-- Updated table structure for table `book`
-- - Changed rating to FLOAT
-- - Added a new column `rating_count`
-- - Changed description column to TEXT for extended content
--
CREATE TABLE `book` (
                        ...
                        `rating_count` VARCHAR(45) NOT NULL,
