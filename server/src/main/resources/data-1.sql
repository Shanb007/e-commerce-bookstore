...
------------------------------------------------------------------
-- Insert final books for each category with short descriptions
------------------------------------------------------------------
...
INSERT INTO book (book_id, title, author, description, price, rating, rating_count, is_public, is_featured, category_id) VALUES
                                                                                                                             ...
                                                                                                                             (2004, 'Book Lovers', 'Emily Henry', 'Enchanting lover story', 1581, 5.0, '243', FALSE, FALSE, 1004),
                                                                                                                             ...
                                                                                                                             (2007, 'Pride and Prejudice', 'Jane Austen', 'Classic love story', 1650, 4.5, '1k', TRUE, FALSE, 1004),
                                                                                                                             (2008, 'The Notebook', 'Nicholas Sparks', 'Sweeping love chronicle', 1800, 4.8, '900', FALSE, TRUE, 1004);
...
INSERT INTO book (book_id, title, author, description, price, rating, rating_count, is_public, is_featured, category_id) VALUES
                                                                                                                             ...
                                                                                                                             (1007, 'Harry Potter and the Sorcerer''s Stone', 'J.K. Rowling', 'Magical wizard adventure', 3000, 4.9, '800', TRUE, TRUE, 1003),
...
INSERT INTO book (book_id, title, author, description, price, rating, rating_count, is_public, is_featured, category_id) VALUES
                                                                                                                             ...
                                                                                                                             (3007, 'The Girl with the Dragon Tattoo', 'Stieg Larsson', 'Hacker journalist mystery', 1750, 4.6, '520', TRUE, FALSE, 1001),
                                                                                                                             (3008, 'Gone Girl', 'Gillian Flynn', 'Psychological missing thriller', 1600, 4.3, '480', FALSE, TRUE, 1001);
...
INSERT INTO book (book_id, title, author, description, price, rating, rating_count, is_public, is_featured, category_id) VALUES
                                                                                                                             ...
                                                                                                                             (4007, 'Hyperion', 'Dan Simmons', 'Cosmic pilgrimage quest', 1900, 4.6, '720', FALSE, FALSE, 1002),
...
INSERT INTO book (book_id, title, author, description, price, rating, rating_count, is_public, is_featured, category_id) VALUES
                                                                                                                             ...
                                                                                                                             (5007, 'The Nightingale', 'Kristin Hannah', 'Sisters wartime struggle', 2100, 4.8, '800', TRUE, FALSE, 1005),
                                                                                                                             (5008, 'The Underground Railroad', 'Colson Whitehead', 'Escape odyssey journey', 2200, 4.7, '780', FALSE, FALSE, 1005);
